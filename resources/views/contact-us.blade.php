...
@section('content')
    <section class="section about-banner">
      <div class="base-container w-container">
        <div class="about-us-banner-wrapper contact-us">
          <h6
            data-w-id="7ec2bacd-b961-2771-3f3a-c20071fb0065"
            style="opacity: 0"
            class="small-title"
          >
            Contact us
          ...
          <h1
            data-w-id="7ec2bacd-b961-2771-3f3a-c20071fb0067"
            style="opacity: 0"
          ...
          <p
            data-w-id="7ec2bacd-b961-2771-3f3a-c20071fb0069"
            style="opacity: 0"
    ...
    <div class="section">
      <div class="base-container w-container">
        <div class="contacts-wrapper">
          <div
            data-w-id="66e64b10-ddaf-41f1-e621-5af172c529ad"
            class="contacts-content-wrapper"
          >
            ...
            <p
              data-w-id="6fd70183-160b-4ca3-6f77-e0bb036de701"
              class="short-text"
            >
            ...
            <div
              data-w-id="5c5755d2-bf55-44a7-6173-837626efdc75"
              class="contacts-divider"
            ></div>
            <div
              data-delay="4000"
              data-animation="slide"
              class="contacts-location-slider w-slider"
              data-autoplay="false"
              data-easing="ease"
            ...
            >
              <div class="w-slider-mask">
                <div class="w-slide">
                  <div class="contacts-detail-wrapper">
                    ...
                    <div
                      data-w-id="382420eb-1d64-9299-a764-92f5db60f558"
                      class="contacts-detail"
                    >
                    ...
                    <div
                      data-w-id="382420eb-1d64-9299-a764-92f5db60f55d"
                      class="contacts-detail"
                    >
                      <p class="contacts-icon"></p>
                      <a href="tel:+12124258617" class="paragraph-no-margin"
                        >+1 212 425 8617</a
                      >
                    </div>
                    <div
                      data-w-id="382420eb-1d64-9299-a764-92f5db60f562"
                      class="contacts-detail"
                    >
                      <p class="contacts-icon"></p>
                      <a
              ...
              <div
                data-w-id="a9732cee-8e6d-a7cb-49ca-10b7915eb91b"
                class="contacts-left-arrow w-slider-arrow-left"
              >
                <div class="contacts-slider-arrow-icon"></div>
              </div>
              <div
                data-w-id="a9732cee-8e6d-a7cb-49ca-10b7915eb91d"
              ...
              <div
                data-w-id="4d5b9da8-feed-51c4-345f-7c4d3371186b"
                class="contacts-arrows-divider"
              ></div>
            </div>
          </div>
          <div
            id="Contact-us"
            data-w-id="92a8d9be-2b86-6361-2ecb-849b408b23c7"
            class="contacts-form-wrapper"
          >
            ...
            <div class="form-block-contacts w-form">
              ...
              >
                ...
                /><textarea
                  ...
                  data-name="field"
                  required=""
                  class="contact-us-text-area w-input"
                ></textarea
                ><input
                  type="submit"
                  data-wait="Please wait..."
                  class="primary-button full-width-mobile w-button"
                  value="Submit"
                />
              </form>
    ...
    <div class="section without-top-spacing">
      <div class="base-container w-container">
        <div class="section-title-wrapper width">
          <h2
            data-w-id="77ed0b3f-71e5-4f7e-045c-b1162c176008"
            style="opacity: 1"
            class="section-title"
          >
          ...
          <p
            data-w-id="77ed0b3f-71e5-4f7e-045c-b1162c17600a"
            style="opacity: 1"
        ...
        <div class="services-wrapper spacing">
          <div
            data-w-id="32cf3b16-32ab-e8b4-7f9d-44251cec289f"
            style="opacity: 1"
            class="item"
          >
          ...
          <div
            data-w-id="5b7055fe-1657-5139-c6fe-016974237594"
            style="opacity: 1"
            class="item"
          >
            <div class="yellow-line"></div>
          ...
          <div
            data-w-id="c4ad2c23-30f4-66dd-87a1-1f255beef314"
            style="opacity: 1"
            class="item"
          >
            <div class="yellow-line"></div>
    ...
    <section class="logo-section">
      <div class="base-container w-container">
        <div
          data-w-id="1d392884-d856-69e5-6077-c8106d2d6cd8"
          style="opacity: 1"
          class="logo-wrapper"
        >
          <img
